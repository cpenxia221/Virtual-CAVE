...
namespace Apt.Unity.Projection
{
    ...
    public class ProjectionPlane : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            BottomLeft = transform.TransformPoint(new Vector3(-Size.x, -heigh * 2) * 0.5f);
            BottomRight = transform.TransformPoint(new Vector3(Size.x, -heigh * 2) * 0.5f);
